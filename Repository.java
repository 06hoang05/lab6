...
public class Repository {
    ...
    public Repository(){
        listProducts.add(new Product("01","Banh doreamon 3 vị", Category.FOOD,100,3500,57));
        ...
        listProducts.add(new Product("05","Thia an com", Category.HOUSEWARE,50,8000,4));
        listProducts.add(new Product("06","Bat dung gia vi", Category.HOUSEWARE,65,4000,44));
        listProducts.add(new Product("07","Nuoc hoa hong", Category.COSMETICS,140,92000,88));
        listProducts.add(new Product("08","Combo dau goi", Category.COSMETICS,100,639000,7));
        listProducts.add(new Product("09","Tinh chat duong am", Category.COSMETICS,50,249000,24));
        listProducts.add(new Product("10","Kem duong am", Category.COSMETICS,80,715000,63));
        listProducts.add(new Product("11","Ao thun", Category.FASHION,250,320000,146));
        listProducts.add(new Product("12","Quan dui", Category.FASHION,100,350000,57));
    }
    public void show(){
